        ...
        <div className="flex items-center gap-8">
          <motion.ul
            ...
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor
                    duration-100 transition-all ease-in-out">Home
            </li>
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor
                    duration-100 transition-all ease-in-out">Menu
            </li>
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor
                    duration-100 transition-all ease-in-out">About Us
            </li>
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor
                    duration-100 transition-all ease-in-out">Service
            </li>
          </motion.ul>
            ...
            isMenu && (
              <motion.div
                ...
                <p className="m-2 p-2 flex items-center justify-center gap-3 cursor-pointer bg-gray-200 hover:bg-slate-300 transition-all
                  rounded-md duration-100 shadow-md ease-in-out text-textColor text-base"
                   onClick={logout}
                >
                  Logout <MdLogout/>
                </p>
